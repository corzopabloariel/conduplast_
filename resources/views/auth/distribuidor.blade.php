            ...
            <div class="modal-body">
                <table class="table mb-0">
                    <tbody>
                        ...
                        <tr>
                            <td>Alt+Ctrl+N</td>
                            <td>Abre o cierra el formulario: solo para secciones que tengan el botón AGREGAR</td>
                        </tr>
                        <tr>
                            <td>Alt+Ctrl+E</td>
                            <td>Papelera: abre registros eliminados</td>
                        </tr>
                        <tr>
                            <td>Alt+Ctrl+M</td>
                            <td>Correos de formularios: muestra los correos enviados desde la parte pública</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="d-flex align-items-center w-100">
            <nav class="navbar justify-content-between w-100 navbar-expand-lg navbar-light p-0">
                <div class="d-flex align-items-center">
                    <button id="btnMenu" class="btn btn-link" type="button" onclick="menu( this )">
                        <i class="fas fa-bars mt-n1"></i>
                    </button>
                    <a class="navbar-brand py-0 mr-0" href="{{ route('adm') }}">ADMIN</a>
                </div>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarNavDropdown">
                    <ul class="navbar-nav px-3">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu shadow" aria-labelledby="navbarDropdownMenuUsuario">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuEmpresa">
                                ...
                                <a class="dropdown-item" href="{{ route('empresa.link') }}"><i class="fas fa-link mr-2"></i>Links del menu</a>
