...
<main class="position-relative d-flex justify-content-center align-items-center" style="height: 100vh;">
    <ol class="breadcrumb bg-white position-absolute by-osole border-bottom-0 border-rigth-0 m-0 rounded-0">
        ...
        <li class="breadcrumb-item" aria-current="page"><a style="color:inherit" target="blank" href="{{ URL::to('/') }}">Página<i class="ml-2 fas fa-external-link-alt"></i></a></li>
        <li class="breadcrumb-item" aria-current="page"><a style="color:inherit" target="blank" href="{{ env('APP_URL') }}"><i class="fas fa-globe-americas"></i></a></li>
